...
const CardHeader = forwardRef(({ className, spacing = "default", ...props }, ref) => {
...
const CardTitle = forwardRef(({ className, as = "h3", size = "default", ...props }, ref) => {
  const Component = as;
  const sizeClasses = {
    sm: "text-lg",
    default: "text-2xl",
...
const CardDescription = forwardRef(({ className, size = "default", ...props }, ref) => {
  const sizeClasses = {
    xs: "text-xs",
    sm: "text-sm",
    default: "text-sm"
...
const CardContent = forwardRef(({ className, removeTopPadding = true, padding = "default", ...props }, ref) => {
...
const CardFooter = forwardRef(({ className, align = "center", direction = "row", ...props }, ref) => {
  const alignClasses = {
    start: "justify-start",
