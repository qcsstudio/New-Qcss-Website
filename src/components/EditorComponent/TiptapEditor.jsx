  ...
  addKeyboardShortcuts() {
    return {
      'Space': ({ editor }) => {
       ...
       editor.commands.insertText(' '); // regular space
        return true;
      },
    };
  },
...
const TiptapEditor = ({ content = '', onChange = () => { } }) => {
  ...
  return (
    <div className="space-y-2 relative">
      ...
      {/* Sticky Toolbar */}
      <div className="sticky top-0 z-10 bg-white shadow-sm flex flex-wrap gap-1 p-2  rounded-t-md border border-b-0 border-gray-300">
        {/* Text Formatting */}
        <button
          onClick={(e) => {
            e.preventDefault();
