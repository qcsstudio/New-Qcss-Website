...
import { flag, projectimage1, projectimage2, projectimage3, projectimage4, upload } from "@/AllAssets/AllAsssets";
...
export default function ProposalForm() {
  ...
  try {
    ...
    return (
        <div className="flex items-center justify-center container mx-auto px-10 mt-10">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full ">
                ...
                <div className="lg:col-span-2 bg-white px-6 space-y-6 border-2 border-gray-300 rounded-xl">
                    <h3 className={` text-[30px] md:text-[40px] font-bold md:text-center mt-10 font-unbounded`}>Tell us about your <span className="text-[#F1813B]">Project</span></h3>
                    <form className={`space-y-7 font-montserrat`} onSubmit={handleSubmit}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="flex items-center border-gray-300 border-b-2 gap-1 p-2">
                                <Image src={flag} width={22} height={16} alt="image" />
                        ...
                        <div className="flex items-center gap-2">
                            <label className="flex items-center cursor-pointer">
                                <Image src={upload} alt="upload" width={78} height={48} />
