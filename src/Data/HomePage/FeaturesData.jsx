 export const HomemiddleFeatures = [
        {
            ...
            description:
                "Marketers and engineers craft cohesive, full-funnel strategies. Marketers and engineers craft cohesive, full-funnel",
        },
        {
    ...
    export const HomerightFeatures = [
        {
            ...
            description:
                "US, UK, AU, IN keyword sets & cultural tone",
        },
        {
            title: "Agile Delivery",
            description:
                "Sprint cycles adapt to market changes rapidly.",
        },
        {
