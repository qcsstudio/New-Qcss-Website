  ...
  return (
    <>
      ...
      <div className={`relative w-[97%] flex items-center  lg:h-[60vh] xl:h-[93vh] mx-auto rounded-lg overflow-hidden mb-10 ${HeroImage ? "text-white" : "text-black"}`}>
        ...
        />}
        {/* Content */}
        <div className="relative lg:w-[62%] xl:w-[55%]  px-10 z-10 space-y-2">
          ...
          <button onClick={() => action()} className="bg-[#F1813B] px-6 py-2 rounded-lg mt-8 hover:bg-orange-600 transition-colors font-unbounded">
