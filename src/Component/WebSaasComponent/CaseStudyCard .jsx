      ...
      <div className="container mx-auto px-10 ">
        ...
        <div className="bg-[#D9D9D9] p-3">
          <div className="sm:block  bg-white p-3  lg:flex gap-3 rounded-xl">
            ...
            <div className="bg-[#3B1414] hidden md:block  lg:w-1/2 sm:w-full sm:mb-2 h-[484px]  rounded-xl "></div>

            {/* Right Side */}
            <div className="w-full   lg:w-1/2  sm:w-full p-6 flex flex-col justify-center border border-[#D9D9D9] rounded-xl">
