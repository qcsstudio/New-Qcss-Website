...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className="sticky top-0 z-40 bg-black/80 backdrop-blur-md" aria-label="Primary">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <Link href="/" className="flex-shrink-0" onClick={handleLinkClick} aria-label="Go to home page">
            <Image
              src={NavbarQcsLogo}
              alt="QCSS Logo"
              width={195}
          ...
          <div className="hidden items-center gap-3 font-montserrat md:flex">
            <button
              className="flex items-center gap-2 rounded-full border border-white/30 px-4 py-2 text-sm text-white transition hover:border-white hover:bg-white/10"
              type="button"
            >
            ...
            <Link href="/contactus" className="inline-flex">
              <button
                className="rounded-full bg-white px-6 py-2 text-sm font-semibold text-black transition hover:bg-white/80"
                type="button"
              >
                Get a Quote
              </button>
      ...
      {/* responsive navbar */}
      {menuOpen && (
        <div className="fixed inset-0 z-30 bg-black/80 backdrop-blur-sm md:hidden" role="dialog" aria-modal="true">
          <div id={menuId} className="flex h-full flex-col justify-between px-6 py-8 sm:px-10">
            ...
            <div className="mt-12 flex flex-1 flex-col justify-between text-center text-lg font-montserrat">
              ...
              <div className="mt-10 space-y-6">
                <button
                  className="flex w-full items-center justify-center gap-2 rounded-full border border-white/40 px-4 py-2 text-base transition hover:border-white hover:bg-white/10"
                  type="button"
                >
                  <IoGlobeOutline className="h-5 w-5" /> En
                </button>
                <Link href="/contactus" onClick={handleLinkClick} className="inline-flex w-full justify-center">
                  <button
                    className="w-full rounded-full bg-white px-6 py-3 text-base font-semibold text-black transition hover:bg-white/80"
                    type="button"
                  >
                    Get a Quote
                  </button>
